...
public interface DummyRestService extends RestClientHeaders {

    // url variables are mapped to method parameter names.
    @Get("?method=flickr.interestingness.getList&api_key=2ce9d959cc02962998397006a002dfdf&format=json&nojsoncallback=1&api_sig=25db9979adde7e8b836c06a41135edff")
